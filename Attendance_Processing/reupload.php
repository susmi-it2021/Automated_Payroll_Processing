...
$sql = "SHOW TABLES FROM reattendance";
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="book">
                    ...
                    <div class="left-page">
                        <h2 class="text-center mb-4">Step -4 Re-importing after solving Inconsistencies</h2>
                        <ul>
                            <li>Break field should contain 2 time value or no value.</li>
                    ...
                    <div class="right-page">
                        <h2 class="text-center">Re-Upload Attendance Records</h2><br>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="book">
                    <!-- Left Page for Instructions -->
                    <div class="left-page">
                        <h2 class="text-center mb-4">Export and Delete the Attendance records</h2>
                        <ul>
                            <li>Consistent attendance records for a single month.</li>
                            <li>Thank you for your cooperation!</li>
                        </ul>
                    </div>
                    <!-- Right Page for File Upload -->
                    <div class="right-page">
                        <h2 class="text-center">Export Attendance Records</h2><br>
                        <form id="deleteForm">
                            <?php
...
<?php
// Connect to the database
$link = mysqli_connect("localhost", "root", "", "reattendance");
if ($link === false) {
    die("ERROR: Could not connect" . mysqli_connect_error());
}
    ...
    <script>
        $(document).ready(function(){
            $('#uploadForm').on('submit', function(e){
                ...
                $.ajax({
                    url: 'reimport.php', // PHP script to handle file upload
                    type: 'POST',
                    data: formData,
                    async: true,
                    cache: false,
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#exportBtn').click(function(){
                var tablename = $("input[name='tablename']:checked").val();
                if(tablename) {
                    window.location = 'reexport.php?tablename=' + tablename;
                } else {
